...
class HTMLDocument extends Document {
  ...
  render() {
    ...
    const links = [
      ...
      { rel: "stylesheet", href: "https://use.typekit.net/zgh8fcm.css" },
      { rel: "stylesheet", href: "https://use.typekit.net/hex8ptm.css" },
      { rel: "stylesheet", href: "https://use.typekit.net/yui7gaq.css" },
      { rel: "stylesheet", href: "https://use.typekit.net/ayo6qdo.css" },
      ...
      { rel: "stylesheet", href: "https://use.typekit.net/bvp0lpd.css"},
      { rel: "stylesheet", href: "https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css"},
      { rel: "stylesheet", href: "/static/css/styles.css"},
      { rel: "stylesheet", href: "/static/css/swiper.min.css"},
      { rel: "stylesheet", href: "/static/css/scroller.css"},
,      ...favicons
    ];
    const meta = [
